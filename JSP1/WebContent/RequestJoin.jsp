...
<body>
	...
	<tr height="50">
		...
		<td width="350" align="center"> <input type="text" name="id" size="40" placeholder="id넣으세요">
		</td>
	<tr height="50">
		<td width="150" align="center"> 패스워드</td>
		<td width="350" align="center"> <input type="password" name="pass1" size="40"
		placeholder="비밀번호는 영문과숫자만 넣어주세요">
		</td>
	<tr height="50">
	...
	<tr height="50">
		...
		<td width="350" align="center"> <input type="email" name="email" size="40" placeholder>
		</td>
	<tr height="50">
