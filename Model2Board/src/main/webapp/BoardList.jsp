...
<c:if test = "${msg != null}">
	...
	<h2>전체 게시글 보기</h2>
		<table width="700" border="1" bordercolor="skyblue">
			...
			<!-- foreach통해서 원하는 데이터 뿌려줌 -->
			
			<!-- 변수 number 받아와서 for문 돌며 1씩 감소 -->
			...
			<tr height = "40">
				...
				<td width = "100" align ="Left">${bean.writer}</td><!-- 작성자 -->
				<td width = "150" align ="Left">${bean.reg_date} </td><!-- 작성일 -->
				<td width = "80" align ="Left">${bean.readcount}</td><!-- 조회수 -->
			</tr>
