 ...
 */
@WebServlet("/BoardListCon.do") //가장먼저 실행
public class BoardListCon extends HttpServlet {
	...
	protected void reqPro(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//현재 보여지고 있는 페이지의 넘버 값을 읽어드림  몇번째 페이지 볼것인지/이전 다음 누를건지
		...
		//		이후 request->jsp 떠넘기고 ->jstl로 화면 출력하면
		...
		dis.forward(request ,response); //forward통해 넘겨줌
}
}